{-| 
  ...
  Based on "foetus" type checker of Andreas Abel and Thorsten Altenkirch 
  (Ludwigs-Maximilians-University, 1997-1999).

-}

module Termination (checkTermLetDefs,checkPosLetDefs) where
import ISyntax
import CallMatrix
