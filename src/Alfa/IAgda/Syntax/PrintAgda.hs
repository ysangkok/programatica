...
instance Print Kind where
  prt _ (Kind i) = doc (showString i)
...
instance Print Def where
  prt i e = case e of
   ...
   Mutual defs -> prPrec i 0 (concatD [doc (showString "mutual") , doc (showString "where") , doc (showString "{") , prt 0 defs , doc (showString "}")])
...
instance Print Exp where
  prt i e = case e of
   ...
   EKind kind -> prPrec i 4 (concatD [prt 0 kind])
   ...
   EIndSum iconstructors -> prPrec i 0 (concatD [doc (showString "idata") , prt 0 iconstructors])
   EPi vardecl exp -> prPrec i 0 (concatD [prt 0 vardecl , doc (showString "->") , prt 0 exp])
   EFun exp0 exp -> prPrec i 0 (concatD [prt 1 exp0 , doc (showString "->") , prt 0 exp])
   EAbs vardecl exp -> prPrec i 0 (concatD [doc (showString "\\") , prt 0 vardecl , doc (showString "->") , prt 0 exp])
...
instance Print VarDecl where
  prt i e = case e of
   VDecl bidents exp -> prPrec i 0 (concatD [doc (showString "(") , prt 0 bidents , doc (showString "::") , prt 0 exp , doc (showString ")")])
...
instance Print IConstructor where
  prt i e = case e of
   ICnstr aident typings exps -> prPrec i 0 (concatD [prt 0 aident , prt 0 typings , doc (showString "::") , doc (showString "_") , prt 0 exps])
...
instance Print OpenArg where
  prt i e = case e of
   OpenArgSimple defattrs aident -> prPrec i 0 (concatD [prt 0 defattrs , prt 0 aident])
   OpenArgTyped defattrs aident exp -> prPrec i 0 (concatD [prt 0 defattrs , prt 0 aident , doc (showString "::") , prt 0 exp])
   OpenArgAs defattrs aident0 aident -> prPrec i 0 (concatD [prt 0 defattrs , prt 0 aident0 , doc (showString "=") , prt 0 aident])
   OpenArgFull defattrs aident0 exp aident -> prPrec i 0 (concatD [prt 0 defattrs , prt 0 aident0 , doc (showString "::") , prt 0 exp , doc (showString "=") , prt 0 aident])
...
instance Print BIdent where
  prt i e = case e of
   C aident -> prPrec i 0 (concatD [prt 0 aident])
