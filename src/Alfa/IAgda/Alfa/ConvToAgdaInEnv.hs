...
module Alfa.ConvToAgdaInEnv where
...
#endif
import Alfa.Agda
import qualified Alfa.UAbstract as U
import qualified Alfa.UAnnots as U
--import qualified AlfModules as UM
import Alfa.AbstractOps(noname,trivialLet,ndStyleLet,printImport)
import Alfa.LitSugar(desugarChar,desugarString,desugarInt,desugarRat)
