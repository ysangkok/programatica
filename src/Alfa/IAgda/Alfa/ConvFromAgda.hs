...
module Alfa.ConvFromAgda(var,con,label,exp,decl,decls,context') where
#ifdef __GLASGOW_HASKELL__
import Prelude hiding (exp) -- to hide exp
#else
--import Prelude hiding (Floating) -- to hide exp
#endif
import qualified Alfa.Agda as Agda
import Alfa.UAbstract
import Alfa.UAnnots
import Alfa.AbstractOps(specialLet)
import Alfa.AlfModules
import Alfa.AbstractOps(noname)
import Alfa.LitSugar(sugarLit)
