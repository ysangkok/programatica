...
newtype Display = Display Int deriving (Eq, Ord, Show)
...
newtype Pixel = Pixel Word deriving (Eq, Ord, Show)
...
data RGB = RGB Int Int Int deriving ( Eq, Ord, Show, Ix )
data Color = Color { colorPixel::Pixel, colorRGB::RGB } deriving (Eq, Ord, Show)
...
data Selection = Selection Atom Atom Atom  deriving (Eq, Ord, Show)


newtype PropertyMode = PropertyMode Int deriving (Eq, Ord, Show)
