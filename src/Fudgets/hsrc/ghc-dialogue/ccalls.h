...
SET(XGCValues,Int,gcv,font,toC f)
...
SET(XGCValues,Int,gcv,stipple,toC p)
SET(XGCValues,Int,gcv,subwindow_mode,fromEnum m)
SET(XGCValues,Int,gcv,tile,toC p)
