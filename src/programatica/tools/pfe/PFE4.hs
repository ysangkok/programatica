...
newtype State4 i ds = PFE4 {un4::PFE4Info i ds}
upd4 f (PFE4 t) = PFE4 (f t)
...
type PFE4MT n i1 i2 ds1 ds2 ext m = PFE3MT n i1 ds1 (State4 i2 ds2,ext) m
...
getSt4 = un4 . fst # lift getSt3ext
updSt4 = lift . updSt3ext . apFst . upd4
setSt4 = updSt4 . const
