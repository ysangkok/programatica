...
instance Storable (Double) where {			    sizeOf    _ = 8;				    alignment _ = 4;			    peekElemOff =  	 readDoubleOffPtr;				    pokeElemOff = writeDoubleOffPtr }
...
instance Storable (Word64) where {			    sizeOf    _ = 8;				    alignment _ = 4;			    peekElemOff =  	 readWord64OffPtr;				    pokeElemOff = writeWord64OffPtr }
...
instance Storable (Int64) where {			    sizeOf    _ = 8;				    alignment _ = 4;			    peekElemOff =  	 readInt64OffPtr;				    pokeElemOff = writeInt64OffPtr }
